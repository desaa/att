...
<div class="row mb-4">
    <div class="col-12">
        <h2 class="fw-bold text-dark">Tambah Pegawai Baru</h2>
        <p class="text-secondary">Tambahkan pegawai baru ke daftar target kunjungan.</p>
    </div>
</div>
    ...
    <div class="col-12 col-lg-8">
        <div class="glass-card">
            <div class="glass-card-body">
                <form action="<?= base_url('pegawai/store') ?>" method="POST" id="pegawaiForm">
                    <?= csrf_field() ?>
                    
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="nip" class="form-label fw-semibold">NIP Pegawai (18 digit)</label>
                            <input type="text" class="form-control font-monospace" id="nip" name="nip" placeholder="Contoh: 199001012015011001" required value="<?= old('nip') ?>">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Contoh: Kepala Bidang TIK" required value="<?= old('jabatan') ?>">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-end gap-2 border-top pt-4">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-4">Simpan Pegawai</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        // Trigger change once to load Bagian for Admin role
        <?php if (!$isSuperadmin): ?>
            $('#kode_bagian').trigger('change');
        <?php endif; ?>
    });
</script>
<?= $this->endSection() ?>
