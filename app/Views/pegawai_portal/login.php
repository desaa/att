...
<head>
    ...
    <title>Login Pegawai - e-AdaTamu</title>
...
<body>
    <div class="wrapper">
        <div class="login-box">
            <form action="<?= base_url('pegawai-portal/login') ?>" method="POST" id="loginForm">
                <?= csrf_field() ?>
                ...
                <div class="input-box">
                    ...
                    <input type="text" id="nip" name="nip" value="<?= old('nip') ?>" required autocomplete="off">
                    <label>NIP</label>
                </div>
                ...
                <div class="captcha-wrapper">
                    ...
                    <div class="slider-container">
                        ...
                        <div class="slider-text">Isi NIP & password untuk verifikasi</div>
                ...
                <div class="register-link">
                    <p>Bukan pegawai? <a href="<?= base_url('login') ?>">Login sebagai Admin <i class="bi bi-arrow-right"></i></a></p>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#nip, #password').on('input change keyup', checkInputs);
